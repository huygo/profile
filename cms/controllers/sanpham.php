...
class sanpham extends controller
{
    ...
    function index()
    {
        ...
        $rows                = isset($_sanphamT['rows']) ? intval($_sanphamT['rows']) : 20;
        $sort                = isset($_sanphamT['sort']) ? strval($_sanphamT['sort']) : 'id';
        $order               = isset($_sanphamT['order']) ? strval($_sanphamT['order']) : 'DESC';
        $offset              = ($page - 1) * $rows;
