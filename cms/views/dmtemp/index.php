<div id="page-wrapper">
    <div class="main-page">
        <div class="tables">
            <h3 class="title1">Danh mục template</h3>
            <div class="bs-example widget-shadow" data-example-id="hoverable-table">
								<a href="dmtemp/add" class="btn btn-default">Thêm danh mục</a>
                               ...
                               $temp=$danhmuc;
                                ...
                                echo '
				                            ...
				                            <td><img src="'.$item['hinh_anh'].'" height="60px" /></td>
																		<td align="center"><a href="dmtemp/battat?id='.$item['id'].'"';
																...
																echo ' <a href="dmtemp/edit?id='.$item['id'].'" class="btn cur-p btn-primary">Sửa</a></td></tr> ';
																$i++;
														}
												}
										?>
...
function xoa(id) {
	if (confirm("Bạn có chắc chắn muốn xóa?"))
			window.location.href = 'dmtemp/xoa?id='+id;
}
	function timkiem() {
		var tukhoa=document.getElementById("tukhoa").value;
		window.location.href = 'dmtemp?tukhoa='+tukhoa;
	}
</script>
